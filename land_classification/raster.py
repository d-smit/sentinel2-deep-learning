...
def calc_ndvi(df):
    ...
    """
    index = (df['B08_1'] - df['B04_1']) / (df['B08_1'] + df['B04_1'])
...
def calc_savi(df, L = 0.5):
    ...
    """
    index = (df['B08_1'] - df['B04_1']) * (1 + L) / (df['B08_1'] + df['B04_1'] + L)
    return clean_index(index)
...
def calc_evi(df, G = 2.5, C1 = 6., C2 = 7.5, L_evi = 1.):
    ...
    """
    index = G * ((df['B08_1'] - df['B04_1']) / ((df['B08_1'] + (C1 * df['B04_1']) - (C2 * df['B02_1'])) + L_evi))
    return clean_index(index)
...
def calc_ndwi(df):
    ...
    """
    index = (df['B03_1'] - df['B08_1']) / (df['B03_1'] + df['B08_1'])
    return clean_index(index)
